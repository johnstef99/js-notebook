...
6. You will see the address that the string is stored and the functions that
   ...
   ![image](./crack_ampl/step_6.png)
7. This brings us here
   ![image](./crack_ampl/step_7.png)
...
8. We need to apply this change on the binary, but if you try to change this
   ...
   the raw binary and not here. So hit **I** to import a file and select the
   ![image](./crack_ampl/step_8.png)
   ampl binary again. But this time make sure the **Format is Raw Binary**.
